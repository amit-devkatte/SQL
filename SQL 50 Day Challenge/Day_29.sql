--Day 29
/*
Find the hotel name and their total numbers of weekends bookings
...
-- select to_char(booking_date, 'day') from bookings;
-- select extract('dow' from booking_date) from bookings;
-- 'dow' is day of week. week start from sunday with 0 count. so saturday :6 and sunday:0

select  hotel_name, count(id) total_bookings
from bookings
...
*/
select hotel_name, payment_type,count(id)
from bookings
group by 1,2
order by 1,2;
