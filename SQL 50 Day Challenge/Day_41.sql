...
user_purchases Columns:
user_id (int) ,date (datetime), amount_spent (float),day_name (varchar)
...
select 
	day_name, extract(week from date) week_number,  avg(amount_spent) average_amount
from user_purchases
