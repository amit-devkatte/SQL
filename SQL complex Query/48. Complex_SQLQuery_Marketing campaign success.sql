--Q48. Marketing campaign success:
/*
You have a table of in-app purchase by user . users that make their first in-app purchase are placed in a marketing campaign where
they see call-to-actions for more in-app purchases.
Find the number of users that made additional in-app purchases due to the sucess of the marketing campaign.

The marketing campaign doesn't start untill one day after the initial in-app purchase so users that only made one or multiple purchases 
...
,first_app_purchases as (
	select * from rank_data where rn =1
)
